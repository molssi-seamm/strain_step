...
class StrainStep(object):
    ...
    comments. The felds are as follows:
        ...
        my_description["description"] : tuple
            A description of the Strain step. It must be
    ...
    my_description = {
        "description": "An interface for Strain",
        "group": "Simulations",
        "name": "Strain",
    }
    ...
    def create_node(self, flowchart=None, **kwargs):
        ...
        **kwargs : keyword arguments
        ...
        return strain_step.Strain(flowchart=flowchart, **kwargs)
    ...
    def create_tk_node(self, canvas=None, **kwargs):
        ...
        **kwargs : keyword arguments
        ...
        return strain_step.TkStrain(canvas=canvas, **kwargs)
    ...
    def description(self):
        ...
        """
        return StrainStep.my_description
